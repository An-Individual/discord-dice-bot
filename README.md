...
Dice Bot is a chat bot that adds slash commands to your Discord server that more or less mimic Roll20's dice rolling syntax. It runs on [Node.js](https://nodejs.org) using [Discord.js](https://discord.js.org). Unfortunately, there is no publicly available version running at this time. Fortunately, standing up a new version of the bot isn't too hard with some modest technical knowledge. It's a fairly powerful dice engine so you can do things like `/r input:(3+{2d6!<2-1,5d8r3r5>3,1d6^3}dl2)*2d6`.
